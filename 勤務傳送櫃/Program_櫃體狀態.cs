...
namespace 勤務傳送系統
{
    public partial class Main_Form : Form
    {
        ...
        private void PlC_RJ_Button_櫃體狀態_重置設備_MouseDownEvent(MouseEventArgs mevent)
        {
            ...
            H_Pannel_lib.Communication.Set_OutputPINTrigger(uDP_Class, myConfigClass.ResetIP, 1, true);
            uDP_Class.Dispose();
        }
        ...
        private void Pannel_Box_CloseEvent(Pannel_Box pannel_Box)
        {
            ...
            Funtion_關門回寫API(pannel_Box.CT_Name, pannel_Box.CT_ID, pannel_Box.WardName, pannel_Box.Number);
            pannel_Box.CT_Name = "";
            pannel_Box.CT_ID = "";
        }
        private void Pannel_Box_OpenEvent(Pannel_Box pannel_Box)
        {
            ...
            Funtion_開門回寫API(pannel_Box.CT_Name, pannel_Box.CT_ID, pannel_Box.WardName, pannel_Box.Number);
        }
